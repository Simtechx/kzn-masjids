...
const Navbar = () => {
  return (
    <nav className="bg-islamic-green text-white py-3 px-4 md:px-6 shadow-md">
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between">
        <div className="flex items-center space-x-2 mb-4 md:mb-0">
          <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center">
            <div className="text-islamic-green text-xl font-bold">KM</div>
          </div>
        ...
        <div className="flex flex-col md:flex-row items-center space-y-3 md:space-y-0 md:space-x-4 w-full md:w-auto">
          ...
          <div className="flex space-x-2 w-full md:w-auto justify-between">
            ...
            <Button className="bg-white text-islamic-green hover:bg-white/90">Contact</Button>
          </div>
        </div>
      </div>
    </nav>
