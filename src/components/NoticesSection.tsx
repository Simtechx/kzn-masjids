...
const NoticesSection = () => {
  ...
  const fallbackNotices: NoticeItem[] = [
    { "File Name": "Community Event - Join Us for Special Gathering", "Image URL": "https://images.unsplash.com/photo-1591604129939-f1efa4d9f7fa?auto=format&fit=crop&q=80&w=800", "Category": "Upcoming" },
    { "File Name": "Islamic Education Workshop - Learn & Grow", "Image URL": "https://images.unsplash.com/photo-1564769625392-651b7c831e21?auto=format&fit=crop&q=80&w=800", "Category": "Upcoming" },
    { "File Name": "Youth Conference - Building Tomorrow's Leaders", "Image URL": "https://images.unsplash.com/photo-1578662996442-48f60103fc96?auto=format&fit=crop&q=80&w=800", "Category": "Upcoming" },
    { "File Name": "Jumuah Prayer Schedule - Updated Timings", "Image URL": "https://images.unsplash.com/photo-1466442929976-97f336a657be?auto=format&fit=crop&q=80&w=800", "Category": "Jumuah" },
    { "File Name": "Special Jumuah Khutbah Series", "Image URL": "https://images.unsplash.com/photo-1492321936769-b49830bc1d1e?auto=format&fit=crop&q=80&w=800", "Category": "Jumuah" },
    { "File Name": "Community Jumuah Gathering", "Image URL": "https://images.unsplash.com/photo-1469474968028-56623f02e42e?auto=format&fit=crop&q=80&w=800", "Category": "Jumuah" },
    { "File Name": "Masjid Guidelines and Community Information", "Image URL": "https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?auto=format&fit=crop&q=80&w=800", "Category": "Info" },
    { "File Name": "Community Support Programs Available", "Image URL": "https://images.unsplash.com/photo-1591604129939-f1efa4d9f7fa?auto=format&fit=crop&q=80&w=800", "Category": "Info" },
    { "File Name": "Volunteer Opportunities - Get Involved", "Image URL": "https://images.unsplash.com/photo-1564769625392-651b7c831e21?auto=format&fit=crop&q=80&w=800", "Category": "Info" }
  ];
  ...
  const getCategoryFromFileName = (fileName: string): string => {
    ...
    if (lower.includes('jumuah')) return 'Jumuah';
    return 'Info';
  };
  ...
  const renderCard = (notice: NoticeItem, index: number) => {
      ...
      >
        {convertedImageUrl ? (
          ...
          <div className="flex flex-col items-center justify-center h-full p-6 text-center bg-white rounded-2xl shadow-2xl">
            ...
            <p className="text-gray-600 text-xs mb-2 font-medium">Image preview unavailable</p>
            <a
      ...
      <div className="container mx-auto max-w-6xl">
        ...
        {loading ? (
          ...
          <div className="relative">
            ...
            >
              {filteredNotices.map(renderCard)}
